...
if __name__ == "__main__":
    ...
    client_secret = 'eb8c032af98f4138817b5294acb8f173'
    auth_client = AzureAuthClient(client_secret)

    # Audio file(s) to transcribe
    audio_file = '/Users/rafiahmed/Downloads/3m3f.st_ns5db.pcm128000.wav'
    ...
    ws_client = websocket.WebSocketApp(
        request_url,
        header=[
            'Authorization: Bearer ' + auth_client.get_access_token().decode('utf-8'),
